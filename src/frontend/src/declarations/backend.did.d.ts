...
export interface _SERVICE {
  ...
  'createNotification' : ActorMethod<
    ...
    undefined
  >,
  'createPost' : ActorMethod<[ExternalBlob, string, Array<string>], bigint>,
  'createStory' : ActorMethod<[ExternalBlob, string], bigint>,
  ...
  'updateUser' : ActorMethod<[string, [] | [ExternalBlob]], undefined>,
}
